...
@Component({
	selector: 'wow-view-procedural-insurance',
	templateUrl: './view-procedural-insurance.component.html',
	styleUrls: ['./view-procedural-insurance.component.scss']
})
export class ViewProceduralInsuranceComponent implements OnInit, OnDestroy {
	...
	constructor(private toastr: ToastrService, private apiService: AdminApiService, 
    ...
    deleteInsurance(insuranceId: number): void{ 
        const endPoint = `/v2/wow-admin/common/${insuranceId}/deleteProceduralInsuranceWow`;
