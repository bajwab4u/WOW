...
import { TeletherapyAppointmentsTableConfig } from '../../../_config/appointments.config';
...
@Component({
  selector: 'wow-teletherapy-appointments',
  templateUrl: './teletherapy-appointments.component.html',
  styleUrls: ['./teletherapy-appointments.component.scss']
})
export class TeletherapyAppointmentsComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal) {
	  ...
	  this.totalItems = 0;
		...
		this.config = new DataTableConfig(TeletherapyAppointmentsTableConfig);
  }
